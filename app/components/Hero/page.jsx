...
export default function Hero() {
    return (
        <>
            {/* Hero */}
            <div className="container text-black py-24 lg:py-32 w-4/5 lg:w-full">
                {/* Grid */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                    <div>
                        <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                            Certificate Tracker
                        </h1>
                        <p className="mt-3 text-xl text-muted-foreground">
                            Input student certificates and keep track of when they get them.
                        </p>
                        {/* Buttons */}
                        <div className="mt-7 grid gap-3 w-full sm:inline-flex">
                            ...
                            <SignedOut>
                                <span
                                    className="bg-black rounded-md px-6 py-2 flex justify-center items-center transition-all duration-200 font-bold text-white btn hover:bg-amber-500"><SignInButton mode="modal">Get Started</SignInButton></span>
                                <span
                                    className="bg-white border-2 border-black rounded-md px-6 py-2 flex justify-center items-center transition-all duration-200 font-bold text-black btn hover:border-amber-600 hover:text-amber-600"><SignInButton mode="modal"/></span>
                            </SignedOut>

                            <SignedIn>
                                <Link href={"/todos"}
                                      className="bg-black rounded-md px-6 py-2 flex justify-center items-center transition-all duration-200 font-bold text-white btn hover:bg-amber-500">Recent
                                    Certificates</Link>
                                <Link href={"/add-task"}
                                      className="bg-white border-2 border-black rounded-md px-6 py-2 flex justify-center items-center transition-all duration-200 font-bold text-black btn hover:border-amber-600 hover:text-amber-600">Add Certificate</Link>
                            </SignedIn>
                        </div>
                        {/* End Buttons */}
                        <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5 flex flex-row justify-start items-center">
                            {/* Review */}
                            <div className="py-5">
                    ...
                    {/* Col */}
                    <div className="relative lg:ms-5 w-full h-[80vh]">
                        <Image
